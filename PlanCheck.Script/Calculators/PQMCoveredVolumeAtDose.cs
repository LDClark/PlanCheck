...
namespace PlanCheck.Calculators
{
    ...
    {
        public static string GetCoveredVolumeAtDose(StructureSet structureSet, PlanningItem planningItem, Structure evalStructure, MatchCollection testMatch, Group evalunit)
        {
