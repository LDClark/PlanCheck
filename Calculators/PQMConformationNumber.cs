...
namespace PlanCheck.Calculators
{
    ...
    {
        public static string GetConformationNumber(StructureSet structureSet, PlanningItem planningItem, Structure evalStructure, MatchCollection testMatch, Group evalunit)
        {
            ...
            double bodyWithPrescribedDoseVolume = planningItem.GetVolumeAtDose(body, prescribedDose, vpFinal);
            double targetWithPrescribedDoseVolume = planningItem.GetVolumeAtDose(evalStructure, dv, vpFinal);
